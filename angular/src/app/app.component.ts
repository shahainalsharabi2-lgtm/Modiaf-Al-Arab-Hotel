...
} from './shared/keyboard-shortcuts/keyboard-shortcuts.util';
  ...
  template: `
    <div
      ...
      <aside
        ...
        <div class="sidebar-brand">
          <div class="brand-logo-frame" aria-hidden="true">
            ...
            <div class="brand-logo-wrap">
              <img [src]="hotelImageSrc" alt="" class="brand-logo-img" />
            </div>
          </div>
          <div class="brand-text">
            <strong class="brand-title" [title]="hotelDisplayName">{{ hotelDisplayName }}</strong>
            <small data-ui-tr-target="brandSubtitle">{{ ui.brandSubtitle() }}</small>
          </div>
        </div>
        ...
        <nav class="sidebar-nav">
          <a
            ...
            <span class="sidebar-nav-label"><ui-inline-text kind="sidebar" [key]="'dashboard'" /></span>
          </a>
          <div
            ...
            <button
              ...
              <span class="sidebar-nav-label"><ui-inline-text kind="sidebar" [key]="'frontDeskGroup'" /></span>
              <i
            ...
            <div class="sidebar-nav-group__tree" *ngIf="frontDeskNavOpen && !navRailCollapsed">
              <ng-container *ngFor="let entry of frontDeskNavEntries">
                <a
                  *ngIf="!isFrontDeskNavSubgroup(entry)"
                  [routerLink]="entry.path"
                  [queryParams]="entry.queryParams ?? null"
                  routerLinkActive="active"
                  [routerLinkActiveOptions]="entry.linkActive"
                  class="sidebar-nav-group__link"
                  [attr.title]="ui.sidebarLabel(entry.labelKey)"
                  [attr.aria-label]="ui.sidebarLabel(entry.labelKey)">
                  <svg
                    *ngIf="isSvgNavIcon(entry.icon)"
                    class="nav-icon-svg"
                    [ngClass]="navIconModifier(entry.icon)"
                    viewBox="0 0 24 24"
                    aria-hidden="true">
                    <use [attr.href]="navIconHref(entry.icon)" />
                  </svg>
                  <i *ngIf="!isSvgNavIcon(entry.icon)" class="fas sidebar-nav-sub-icon" [ngClass]="entry.icon" aria-hidden="true"></i>
                  <span class="sidebar-nav-label"><ui-inline-text kind="sidebar" [key]="entry.labelKey" /></span>
                </a>
                <div
                  *ngIf="isFrontDeskNavSubgroup(entry)"
                  class="sidebar-nav-subgroup"
                  [class.sidebar-nav-subgroup--active]="frontDeskKeyMgmtSectionActive">
                  <button
                    type="button"
                    class="sidebar-nav-subgroup__head"
                    (click)="toggleFrontDeskKeyMgmt($event)"
                    [attr.aria-expanded]="frontDeskKeyMgmtOpen"
                    [attr.title]="ui.sidebarLabel(entry.labelKey)"
                    [attr.aria-label]="ui.sidebarLabel(entry.labelKey)">
                    <i class="fas sidebar-nav-sub-icon" [ngClass]="entry.icon" aria-hidden="true"></i>
                    <span class="sidebar-nav-label"><ui-inline-text kind="sidebar" [key]="entry.labelKey" /></span>
                    <i
                      class="fas sidebar-nav-group__chevron"
                      [class.fa-chevron-up]="frontDeskKeyMgmtOpen"
                      [class.fa-chevron-down]="!frontDeskKeyMgmtOpen"
                      aria-hidden="true"></i>
                  </button>
                  <div class="sidebar-nav-subgroup__tree" *ngIf="frontDeskKeyMgmtOpen">
                    <a
                      *ngFor="let item of entry.children"
                      ...
                      <i class="fas sidebar-nav-sub-icon" [ngClass]="item.icon" aria-hidden="true"></i>
                      <span class="sidebar-nav-label"><ui-inline-text kind="sidebar" [key]="item.labelKey" /></span>
                    </a>
                  </div>
                </div>
              </ng-container>
          ...
          <div
            ...
            <button
              ...
              <span class="sidebar-nav-label"><ui-inline-text kind="sidebar" [key]="'bookingsGroup'" /></span>
              <i
                class="fas sidebar-nav-group__chevron"
            ...
            <div class="sidebar-nav-group__tree" *ngIf="bookingsNavOpen && !navRailCollapsed">
              <a
                *ngFor="let item of bookingsNavItems"
                ...
                <i *ngIf="!isSvgNavIcon(item.icon)" class="fas sidebar-nav-sub-icon" [ngClass]="item.icon" aria-hidden="true"></i>
                <span class="sidebar-nav-label"><ui-inline-text kind="sidebar" [key]="item.labelKey" /></span>
              </a>
            </div>
          </div>
          <div
            *ngFor="let group of pmsSidebarGroups"
            class="sidebar-nav-group"
            [class.sidebar-nav-group--open]="isPmsNavOpen(group.section)"
            [class.sidebar-nav-group--section-active]="isPmsSectionActive(group.section)"
            [class.sidebar-nav-group--flyout-active]="navRailCollapsed && collapsedNavFlyout === group.section">
            <button
              type="button"
              class="sidebar-nav-group__head"
              (click)="togglePmsNav(group.section, $event)"
              [attr.aria-expanded]="isPmsNavOpen(group.section)"
              [attr.title]="ui.sidebarLabel(group.labelKey)"
              [attr.aria-label]="ui.sidebarLabel(group.labelKey)">
              <i class="fas sidebar-nav-group__main-icon" [ngClass]="group.faIcon" aria-hidden="true"></i>
              <span class="sidebar-nav-label"><ui-inline-text kind="sidebar" [key]="group.labelKey" /></span>
              <i
                class="fas sidebar-nav-group__chevron"
                [class.fa-chevron-up]="isPmsNavOpen(group.section)"
                [class.fa-chevron-down]="!isPmsNavOpen(group.section)"
                aria-hidden="true"></i>
            </button>
            <div class="sidebar-nav-group__tree" *ngIf="isPmsNavOpen(group.section) && !navRailCollapsed">
              <a
          ...
          <div
            ...
            <button
              ...
              <span class="sidebar-nav-label"><ui-inline-text kind="sidebar" [key]="'settings'" /></span>
              <i
                class="fas sidebar-nav-group__chevron"
            ...
            <div class="sidebar-nav-group__tree" *ngIf="settingsNavOpen && !navRailCollapsed">
              <ng-container *ngFor="let entry of settingsSidebarNavEntries">
                <a
                  *ngIf="!isSettingsSidebarNavSubgroup(entry) && settingsSidebarLinkVisible(entry)"
                  [routerLink]="entry.path"
                  [queryParams]="entry.queryParams ?? null"
                  routerLinkActive="active"
                  [routerLinkActiveOptions]="entry.linkActive"
                ...
                <div
                  *ngIf="isSettingsSidebarNavSubgroup(entry) && settingsSubgroupVisible(entry)"
                  class="sidebar-nav-subgroup"
                  [class.sidebar-nav-subgroup--active]="isSettingsSubgroupActive(entry.id)">
                  <button
                    type="button"
                    class="sidebar-nav-subgroup__head"
                    (click)="toggleSettingsSubgroup(entry.id, $event)"
                    [attr.aria-expanded]="isSettingsSubgroupOpen(entry.id)"
                    [attr.title]="ui.sidebarLabel(entry.labelKey)"
                    [attr.aria-label]="ui.sidebarLabel(entry.labelKey)">
                    <svg
                      *ngIf="isSvgNavIcon(entry.icon)"
                    ...
                    <i
                      class="fas sidebar-nav-group__chevron"
                      [class.fa-chevron-up]="isSettingsSubgroupOpen(entry.id)"
                      [class.fa-chevron-down]="!isSettingsSubgroupOpen(entry.id)"
                      aria-hidden="true"></i>
                  </button>
                  <div class="sidebar-nav-subgroup__tree" *ngIf="isSettingsSubgroupOpen(entry.id)">
                    <a
                      *ngFor="let item of entry.children"
                      [hidden]="!settingsSidebarLinkVisible(item)"
                      [routerLink]="item.path"
                      [queryParams]="item.queryParams ?? null"
                      routerLinkActive="active"
                      [routerLinkActiveOptions]="item.linkActive"
          ...
          <div
            class="sidebar-nav-group sidebar-nav-group--reports"
            ...
            <button
              ...
              <span class="sidebar-nav-label"><ui-inline-text kind="sidebar" [key]="'reports'" /></span>
              <i
                class="fas sidebar-nav-group__chevron"
            ...
            <div class="sidebar-nav-group__tree sidebar-nav-group__tree--reports" *ngIf="reportsNavOpen && !navRailCollapsed">
              <a
                *ngFor="let item of reportsNavHubItems"
                [routerLink]="item.path"
                [queryParams]="item.queryParams ?? null"
                routerLinkActive="active"
                [routerLinkActiveOptions]="item.linkActive"
                class="sidebar-nav-group__link sidebar-nav-group__link--reports-hub"
                [attr.title]="ui.sidebarLabel(item.labelKey)"
                [attr.aria-label]="ui.sidebarLabel(item.labelKey)">
                <svg
                  *ngIf="isSvgNavIcon(item.icon)"
      ...
      <button
        ...
        "
        data-ui-tr-chrome-keys="navRailExpandTitle,navRailExpandAria,navRailCollapseTitle,navRailCollapseAria">
        <i
          class="fas"
        ...
        *ngIf="navRailCollapsed && collapsedNavFlyout as flyoutId"
        ...
        (click)="$event.stopPropagation()">
          ...
          <div class="sidebar-nav-flyout__body" [ngSwitch]="flyoutId">
            <ng-container *ngSwitchCase="'bookings'">
              <a
                *ngFor="let item of bookingsNavItems"
                ...
                <i *ngIf="!isSvgNavIcon(item.icon)" class="fas sidebar-nav-sub-icon sidebar-nav-flyout__icon-fa" [ngClass]="item.icon" aria-hidden="true"></i>
                <span class="sidebar-nav-label"><ui-inline-text kind="sidebar" [key]="item.labelKey" /></span>
              </a>
            </ng-container>
              ...
              <ng-container *ngFor="let entry of frontDeskNavEntries">
                <a
                  *ngIf="!isFrontDeskNavSubgroup(entry)"
                  ...
                  <i *ngIf="!isSvgNavIcon(entry.icon)" class="fas sidebar-nav-sub-icon sidebar-nav-flyout__icon-fa" [ngClass]="entry.icon" aria-hidden="true"></i>
                  <span class="sidebar-nav-label"><ui-inline-text kind="sidebar" [key]="entry.labelKey" /></span>
                </a>
                <div
                  *ngIf="isFrontDeskNavSubgroup(entry)"
                  class="sidebar-nav-flyout__subgroup"
                  [class.sidebar-nav-flyout__subgroup--active]="frontDeskKeyMgmtSectionActive">
                  <button
                    type="button"
                    class="sidebar-nav-flyout__subgroup-head"
                    (click)="toggleFrontDeskKeyMgmt($event)"
                    [attr.aria-expanded]="frontDeskKeyMgmtOpen"
                    [attr.title]="ui.sidebarLabel(entry.labelKey)"
                    [attr.aria-label]="ui.sidebarLabel(entry.labelKey)">
                    <i class="fas sidebar-nav-sub-icon sidebar-nav-flyout__icon-fa" [ngClass]="entry.icon" aria-hidden="true"></i>
                    <span class="sidebar-nav-label"><ui-inline-text kind="sidebar" [key]="entry.labelKey" /></span>
                    <i
                      class="fas sidebar-nav-flyout__chevron"
                      [class.fa-chevron-up]="frontDeskKeyMgmtOpen"
                      [class.fa-chevron-down]="!frontDeskKeyMgmtOpen"
                      aria-hidden="true"></i>
                  </button>
                  <div class="sidebar-nav-flyout__subgroup-tree" *ngIf="frontDeskKeyMgmtOpen">
                    <a
                      *ngFor="let item of entry.children"
                      [routerLink]="item.path"
                      [queryParams]="item.queryParams ?? null"
                      routerLinkActive="active"
                      [routerLinkActiveOptions]="item.linkActive"
                      class="sidebar-nav-flyout__link sidebar-nav-flyout__link--nested"
                      (click)="closeCollapsedNavFlyout()"
                      [attr.title]="ui.sidebarLabel(item.labelKey)">
                      <i class="fas sidebar-nav-sub-icon sidebar-nav-flyout__icon-fa" [ngClass]="item.icon" aria-hidden="true"></i>
                      <span class="sidebar-nav-label"><ui-inline-text kind="sidebar" [key]="item.labelKey" /></span>
                    </a>
                  </div>
                </div>
            ...
            <ng-container *ngIf="isPmsFlyout(flyoutId)">
              <a
                *ngFor="let item of pmsSidebarGroup(flyoutId).items"
                [routerLink]="item.path"
                [queryParams]="item.queryParams ?? null"
                routerLinkActive="active"
                [routerLinkActiveOptions]="item.linkActive"
            ...
            <ng-container *ngSwitchCase="'settings'">
              <ng-container *ngFor="let entry of settingsSidebarNavEntries">
                ...
                <div
                  *ngIf="isSettingsSidebarNavSubgroup(entry) && settingsSubgroupVisible(entry)"
                  class="sidebar-nav-flyout__subgroup"
                  [class.sidebar-nav-flyout__subgroup--active]="isSettingsSubgroupActive(entry.id)">
                  <button
                    type="button"
                    class="sidebar-nav-flyout__subgroup-head"
                    (click)="toggleSettingsSubgroup(entry.id, $event)"
                  ...
                  <div class="sidebar-nav-flyout__subgroup-tree" *ngIf="isSettingsSubgroupOpen(entry.id)">
                    <a
                      *ngFor="let item of entry.children"
                      [hidden]="!settingsSidebarLinkVisible(item)"
                      [routerLink]="item.path"
      ...
      <div class="app-main-column" [class.app-main-column--login]="!showMainChrome">
        ...
        <main class="app-content" [class.app-content--login]="!showMainChrome">
          <div class="ui-inline-workbench-hint" *ngIf="showMainChrome && ui.inlineWorkbenchActive()">
            {{ ui.inlineWorkbenchHintLabel() }}
          </div>
      ...
      <button
        ...
        [class.lang-rail-edge-toggle--active]="ui.inlineTranslationMode()"
        [class.lang-rail-edge-toggle--saving]="ui.inlineTranslationSaving()"
        (click)="toggleInlineTranslationOnPage($event)"
        [attr.title]="
          ui.inlineTranslationMode()
            ? ui.chromeLabel('uiInlineTranslationSaveExit')
            : ui.chromeLabel('uiInlineTranslationToggleOn')
        "
        [attr.aria-label]="
          ui.inlineTranslationMode()
            ? ui.chromeLabel('uiInlineTranslationSaveExit')
            : ui.chromeLabel('uiInlineTranslationToggleOn')
        "
        [attr.aria-pressed]="ui.inlineTranslationMode()">
        <span class="lang-rail-edge-toggle__stack" aria-hidden="true">
          <i
            class="fas fa-language lang-rail-edge-toggle__icon"
            *ngIf="!ui.inlineTranslationSaving()"></i>
          <i
            class="fas fa-spinner fa-spin lang-rail-edge-toggle__icon"
            *ngIf="ui.inlineTranslationSaving()"></i>
          <i
            class="fas fa-save lang-rail-edge-toggle__badge"
            *ngIf="ui.inlineTranslationMode() && !ui.inlineTranslationSaving()"></i>
        </span>
        <span class="lang-rail-edge-toggle__label">
          {{
            ui.inlineTranslationMode()
              ? ui.chromeLabel('uiInlineTranslationSave')
              : ui.chromeLabel('translationMenuTitle')
          }}
        </span>
      </button>
        ...
        <div class="app-search-modal" (click)="$event.stopPropagation()">
          <div class="app-search-bar">
            ...
            <input
              ...
              [attr.aria-label]="ui.chromeLabel('searchOverlayAria')"
              autocomplete="off" />
            <kbd class="app-search-bar__esc"><ui-inline-text kind="chrome" key="searchOverlayEsc" /></kbd>
          </div>
          ...
          <p class="app-search-empty" *ngIf="filteredSearchResults.length === 0 && searchQuery.trim()">
            <ui-inline-text kind="chrome" key="searchOverlayPlaceholder" />
          </p>
        </div>
      </div>
  ...
  styles: [
    ...
    .lang-rail-edge-toggle {
      ...
      box-shadow:
        ...
        0 8px 22px rgba(21, 101, 192, 0.38);
      transition:
        background 0.2s ease,
        border-color 0.2s ease,
        box-shadow 0.2s ease,
    ...
    .lang-rail-edge-toggle--fab {
      z-index: 60;
    }

    .lang-rail-edge-toggle__stack {
      position: relative;
      display: inline-flex;
      align-items: center;
      justify-content: center;
    ...
    .lang-rail-edge-toggle__icon {
      font-size: 1.45rem;
      line-height: 1;
    }

    .lang-rail-edge-toggle__badge {
      position: absolute;
      top: -0.2rem;
    ...
    .app-shell--lang-rail-open .lang-rail-edge-toggle {
      inset-inline-end: calc(var(--lang-rail-width, 168px) + 1rem);
    }
    ...
    .lang-rail-edge-toggle:hover {
      ...
      box-shadow:
        ...
        0 10px 24px rgba(21, 101, 192, 0.45);
    }
    ...
    .lang-rail-edge-toggle--active {
      ...
      box-shadow:
        ...
        0 8px 18px rgba(21, 101, 192, 0.35);
    }

    .lang-rail-edge-toggle--active .utility-edge-icon,
    .lang-rail-edge-toggle--active .fas {
      color: #ffffff;
    }

    .lang-rail-edge-toggle--saving {
      opacity: 0.88;
    }
    ...
    .account-rail-group--translation .account-rail-group__head--action {
      cursor: pointer;
    }

    .account-rail-group--translation .account-rail-group__main-icon--svg {
      color: #1565c0;
    }
    ...
    .sidebar-nav-group__link .nav-icon-svg,
    .sidebar-nav-flyout__link .nav-icon-svg {
      width: 20px;
      height: 20px;
      flex-shrink: 0;
    }
    ...
    .sidebar-nav-group--reports.sidebar-nav-group--open .sidebar-nav-group__head,
    .sidebar-nav-group--reports.sidebar-nav-group--section-active .sidebar-nav-group__head {
      background: rgba(15, 23, 42, 0.34);
      color: #ffffff;
      border-radius: 12px;
    }

    .sidebar-nav-group--reports .sidebar-nav-group__head .nav-icon-svg {
      width: 22px;
      height: 22px;
      padding: 0;
      background: transparent;
    ...
    .sidebar-nav-group__tree--reports {
      margin-top: 0.35rem;
    ...
    .sidebar-nav-group__link--reports-hub,
    .sidebar-nav-group__link--reports-report {
      padding: 0.52rem 0.55rem;
      font-size: 0.84rem;
    }

    .sidebar-nav-group__link--reports-hub > i.fas,
    .sidebar-nav-group__link--reports-report > i.fas {
      width: 18px;
      min-width: 18px;
      height: 18px;
      font-size: 0.68rem;
    ...
    .sidebar-nav-group__link--reports-hub .nav-icon-svg,
    .sidebar-nav-group__link--reports-report .nav-icon-svg {
      width: 18px;
      height: 18px;
      padding: 0;
      border-radius: 6px;
    ...
    .sidebar-nav-flyout__subgroup {
      display: flex;
      flex-direction: column;
      gap: 0.06rem;
    }

    .sidebar-nav-flyout__subgroup-head {
      display: flex;
      flex-direction: row;
      align-items: center;
      gap: 0.65rem;
    ...
    .sidebar-nav-flyout__subgroup-head span {
      flex: 1;
      min-width: 0;
      text-align: start;
      line-height: 1.3;
    ...
    .sidebar-nav-flyout__subgroup-head:hover,
    .sidebar-nav-flyout__subgroup--active .sidebar-nav-flyout__subgroup-head {
      background: #1565c0;
      color: #ffffff;
    }

    .sidebar-nav-flyout__chevron {
      margin-inline-start: auto;
      font-size: 0.7rem;
      opacity: 0.85;
      flex-shrink: 0;
    ...
    .sidebar-nav-flyout__subgroup-tree {
      display: flex;
      flex-direction: column;
      gap: 0.06rem;
      margin-inline-start: 0.85rem;
    ...
    .sidebar-nav-flyout__link--nested {
      padding-inline-start: 0.65rem;
    }

    .sidebar-nav-flyout__subgroup-head:hover .sidebar-nav-flyout__icon-fa,
    .sidebar-nav-flyout__subgroup--active .sidebar-nav-flyout__subgroup-head .sidebar-nav-flyout__icon-fa,
    .sidebar-nav-flyout__subgroup-head:hover .sidebar-nav-flyout__chevron,
    .sidebar-nav-flyout__subgroup--active .sidebar-nav-flyout__subgroup-head .sidebar-nav-flyout__chevron {
      color: #ffffff;
    }
    ...
    .sidebar-nav-flyout__link > i.fas,
    .sidebar-nav-flyout .sidebar-nav-sub-icon {
      color: #bbdefb;
    }
    ...
    .sidebar-nav-group__head > .nav-icon-svg {
      width: 30px;
      height: 30px;
    }
    ...
    .sidebar-nav > a .nav-icon-svg--bookings {
      color: rgba(255, 255, 255, 0.92);
    }
    ...
    .sidebar-nav-flyout .nav-icon-svg {
      width: 20px;
      height: 20px;
    }
    ...
    .utility-rail-header__link:hover {
    ...
    .app-shell--inline-translating a[href],
    .app-shell--inline-translating a[routerlink],
    .app-shell--inline-translating [routerlink] {
      pointer-events: none;
      cursor: default;
    }

    .app-shell--inline-translating .ui-inline-wrap,
    .app-shell--inline-translating .ui-inline-wrap * {
      pointer-events: auto;
      cursor: pointer;
    }

    .app-shell--inline-translating .lang-rail-edge-toggle,
    .app-shell--inline-translating .lang-picker,
    .app-shell--inline-translating .app-top-bar__locale,
    .app-shell--inline-translating .app-top-bar__locale * {
      pointer-events: auto;
    }
    ...
    @media (max-width: 900px) {
      ...
      .sidebar-edge-toggle:not(.lang-rail-edge-toggle--fab),
      .app-lang-rail {
        display: none;
      }
...
export class AppComponent implements OnInit {
  ...
  collapsedNavFlyout: SidebarMainSection | null = null;
  flyoutTop = 0;
  flyoutLeft = 0;
  ...
  frontDeskKeyMgmtOpen = false;

  pmsNavOpen: Record<PmsSidebarSection, boolean> = {
    cashier: false,
    crm: false,
    nightAuditor: false,
    housekeeping: false,
  ...
  readonly pmsSidebarGroups = PMS_SIDEBAR_GROUPS;

  /** قائمة الإعدادات القابلة للطي (نفس أسلوب الحجوزات) */
  settingsNavOpen = false;

  settingsNavSubgroupsOpen: Record<string, boolean> = {
    systemSetup: false,
    masterData: false,
    roomMgmt: false,
    tax: false,
  ...
  readonly settingsSidebarNavItems = SETTINGS_SIDEBAR_NAV_ITEMS;
  readonly isSettingsSidebarNavSubgroup = isSettingsSidebarNavSubgroup;

  readonly bookingsNavItems = BOOKINGS_NAV_ITEMS;

  readonly frontDeskNavEntries = FRONT_DESK_NAV_ENTRIES;
  readonly frontDeskNavItems = FRONT_DESK_NAV_ITEMS;
  readonly isFrontDeskNavSubgroup = isFrontDeskNavSubgroup;

  /** قائمة التقارير القابلة للطي */
  reportsNavOpen = false;

  readonly reportsNavItems = REPORTS_NAV_ITEMS;
  readonly reportsNavHubItems = REPORTS_NAV_HUB_ITEMS;
  ...
  get frontDeskKeyMgmtSectionActive(): boolean {
    return this.isFrontDeskKeyMgmtUrl(this.router.url);
  }

  toggleFrontDeskKeyMgmt(event?: Event): void {
    event?.stopPropagation();
    this.frontDeskKeyMgmtOpen = !this.frontDeskKeyMgmtOpen;
  ...
  get settingsSectionActive(): boolean {
    ...
    return path.startsWith('/settings') || sidebarSectionFromNavPath(path) === 'settings';
  }
  ...
  private disableInlineTranslationOnUiTranslationsPage(): void {
    if (!this.isUiTranslationsSettingsPage() || !this.ui.inlineTranslationMode()) {
      return;
    }
  ...
  isPmsSectionActive(section: PmsSidebarSection): boolean {
    switch (section) {
      case 'cashier':
        return this.isCashierSectionUrl(this.router.url);
      case 'crm':
        return this.isCrmSectionUrl(this.router.url);
      case 'nightAuditor':
        return this.isNightAuditorSectionUrl(this.router.url);
      case 'housekeeping':
        return this.isHousekeepingSectionUrl(this.router.url);
      case 'accounts':
        return this.isAccountsSectionUrl(this.router.url);
    }
  }

  isPmsNavOpen(section: PmsSidebarSection): boolean {
    return this.pmsNavOpen[section];
  }

  togglePmsNav(section: PmsSidebarSection, event?: Event): void {
    event?.stopPropagation();
    if (this.navRailCollapsed) {
      this.toggleCollapsedNavFlyout(section, event?.currentTarget);
      this.cdr.markForCheck();
      return;
    }
    if (this.pmsNavOpen[section]) {
      this.closeSidebarSection(section);
    } else {
  ...
  pmsSidebarGroup(section: PmsSidebarSection) {
    return this.pmsSidebarGroups.find((g) => g.section === section)!;
  }

  isPmsFlyout(id: SidebarMainSection | null): id is PmsSidebarSection {
    return (
      id === 'cashier' ||
      id === 'crm' ||
      id === 'nightAuditor' ||
  ...
  ngOnInit(): void {
    ...
    const blockNavClick = (event: MouseEvent) => this.blockNavigationWhileTranslating(event);
    document.addEventListener('click', blockNavClick, true);
    this.destroyRef.onDestroy(() => document.removeEventListener('click', blockNavClick, true));
  ...
  onDocumentKeydown(event: KeyboardEvent): void {
    ...
    if (!isEditableKeyboardTarget(shortcutTarget)) {
  ...
  private buildSearchEntries(): AppSearchEntry[] {
    ...
    return [
      ...
      {
        id: 'room-plan',
        title: this.ui.sidebarLabel('navRoomPlan'),
        breadcrumb: `${fd} / ${this.ui.sidebarLabel('navRoomPlan')}`,
        tag: this.ui.chromeLabel('searchTagFrontDesk'),
        pathSegments: ['/front-desk', 'room-plan'],
      },
      {
        id: 'rooms-rack',
        title: this.ui.sidebarLabel('navRoomRack'),
        breadcrumb: `${this.ui.sidebarLabel('frontDeskGroup')} / ${this.ui.sidebarLabel('navRoomRack')}`,
        tag: this.ui.sidebarLabel('frontDeskGroup'),
        pathSegments: ['/front-desk', 'rooms-rack'],
      },
      {
        id: 'guest-valuables',
        title: this.ui.sidebarLabel('navGuestValuables'),
        breadcrumb: `${this.ui.sidebarLabel('frontDeskGroup')} / ${this.ui.sidebarLabel('navGuestValuables')}`,
        tag: this.ui.sidebarLabel('frontDeskGroup'),
        pathSegments: ['/front-desk', 'guest-valuables'],
      },
      {
        id: 'keys',
        title: this.ui.sidebarLabel('navKeys'),
        breadcrumb: `${this.ui.sidebarLabel('frontDeskGroup')} / ${this.ui.sidebarLabel('navKeyManagement')} / ${this.ui.sidebarLabel('navKeys')}`,
        tag: this.ui.sidebarLabel('frontDeskGroup'),
        pathSegments: ['/front-desk', 'keys'],
      },
      {
        id: 'key-services',
        title: this.ui.sidebarLabel('navKeyServices'),
        breadcrumb: `${this.ui.sidebarLabel('frontDeskGroup')} / ${this.ui.sidebarLabel('navKeyManagement')} / ${this.ui.sidebarLabel('navKeyServices')}`,
        tag: this.ui.sidebarLabel('frontDeskGroup'),
        pathSegments: ['/front-desk', 'key-services'],
      },
      {
        id: 'rent-posting',
        title: this.ui.sidebarLabel('navRentPosting'),
        breadcrumb: `${this.ui.sidebarLabel('cashierGroup')} / ${this.ui.sidebarLabel('navRentPosting')}`,
        tag: this.ui.sidebarLabel('cashierGroup'),
        pathSegments: ['/cashier', 'rent-posting'],
      },
      {
        id: 'previous-invoices',
        title: this.ui.sidebarLabel('navPreviousInvoices'),
        breadcrumb: `${this.ui.sidebarLabel('cashierGroup')} / ${this.ui.sidebarLabel('navPreviousInvoices')}`,
        tag: this.ui.sidebarLabel('cashierGroup'),
        pathSegments: ['/cashier', 'previous-invoices'],
      },
      {
        id: 'invoices-notifications',
        title: this.ui.sidebarLabel('navInvoicesNotifications'),
        breadcrumb: `${this.ui.sidebarLabel('cashierGroup')} / ${this.ui.sidebarLabel('navInvoicesNotifications')}`,
        tag: this.ui.sidebarLabel('cashierGroup'),
        pathSegments: ['/cashier', 'invoices-notifications'],
      },
      {
        id: 'crm-profile-settings',
        title: this.ui.sidebarLabel('navCrmProfileSettings'),
        breadcrumb: `${this.ui.sidebarLabel('crmGroup')} / ${this.ui.sidebarLabel('navCrmProfileSettings')}`,
        tag: this.ui.sidebarLabel('crmGroup'),
        pathSegments: ['/crm', 'profile-settings'],
      },
      {
        id: 'crm-individuals',
        title: this.ui.sidebarLabel('navCrmIndividuals'),
        breadcrumb: `${this.ui.sidebarLabel('crmGroup')} / ${this.ui.sidebarLabel('navCrmIndividuals')}`,
        tag: this.ui.sidebarLabel('crmGroup'),
        pathSegments: ['/crm', 'individuals'],
      },
      {
        id: 'crm-companies',
        title: this.ui.sidebarLabel('navCrmCompanies'),
        breadcrumb: `${this.ui.sidebarLabel('crmGroup')} / ${this.ui.sidebarLabel('navCrmCompanies')}`,
        tag: this.ui.sidebarLabel('crmGroup'),
        pathSegments: ['/crm', 'companies'],
      },
      {
        id: 'crm-agents',
        title: this.ui.sidebarLabel('navCrmAgents'),
        breadcrumb: `${this.ui.sidebarLabel('crmGroup')} / ${this.ui.sidebarLabel('navCrmAgents')}`,
        tag: this.ui.sidebarLabel('crmGroup'),
        pathSegments: ['/crm', 'agents'],
      },
      {
        id: 'night-audit-settings',
        title: this.ui.sidebarLabel('navNightAuditorSettings'),
        breadcrumb: `${this.ui.sidebarLabel('nightAuditorGroup')} / ${this.ui.sidebarLabel('navNightAuditorSettings')}`,
        tag: this.ui.sidebarLabel('nightAuditorGroup'),
        pathSegments: ['/night-auditor', 'settings'],
      },
      {
        id: 'night-audit-reservations',
        title: this.ui.sidebarLabel('navNightAuditReservations'),
        breadcrumb: `${this.ui.sidebarLabel('nightAuditorGroup')} / ${this.ui.sidebarLabel('navNightAuditReservations')}`,
        tag: this.ui.sidebarLabel('nightAuditorGroup'),
        pathSegments: ['/night-auditor', 'reservations-review'],
      },
      {
        id: 'night-audit-procedure',
        title: this.ui.sidebarLabel('navNightAuditProcedure'),
        breadcrumb: `${this.ui.sidebarLabel('nightAuditorGroup')} / ${this.ui.sidebarLabel('navNightAuditProcedure')}`,
        tag: this.ui.sidebarLabel('nightAuditorGroup'),
        pathSegments: ['/night-auditor', 'procedure'],
      },
      {
        id: 'night-audit-room-movement',
        title: this.ui.sidebarLabel('navNightAuditRoomMovement'),
        breadcrumb: `${this.ui.sidebarLabel('nightAuditorGroup')} / ${this.ui.sidebarLabel('navNightAuditRoomMovement')}`,
        tag: this.ui.sidebarLabel('nightAuditorGroup'),
        pathSegments: ['/night-auditor', 'room-movement'],
      },
      {
        id: 'arriving',
  ...
  async toggleInlineTranslationOnPage(event?: Event): Promise<void> {
    ...
    if (this.ui.inlineTranslationMode()) {
      ...
      await UiInlineTextComponent.flushActiveSave();
  ...
  private blockNavigationWhileTranslating(event: MouseEvent): void {
    if (!this.ui.inlineTranslationMode()) {
      return;
    }
    const target = event.target as HTMLElement | null;
    ...
    if (
      target.closest(
        '.ui-inline-wrap, .lang-rail-edge-toggle, .lang-picker, .app-top-bar__locale',
      )
    ) {
      return;
    }
    const link = target.closest('a[href], [routerlink], a[ng-reflect-router-link]');
    if (!link) {
      return;
    }
    event.preventDefault();
  ...
  settingsSubgroupVisible(entry: { id: string }): boolean {
    if (entry.id === 'users') {
  ...
  toggleSettingsSubgroup(sectionId: string, event?: Event): void {
    event?.stopPropagation();
    this.settingsNavSubgroupsOpen[sectionId] = !this.settingsNavSubgroupsOpen[sectionId];
    this.cdr.markForCheck();
  }

  isSettingsSubgroupOpen(sectionId: string): boolean {
    return !!this.settingsNavSubgroupsOpen[sectionId];
  }

  isSettingsSubgroupActive(sectionId: string): boolean {
    if (!this.settingsSectionActive) {
      return false;
    }
    const params = new URL(this.router.url, 'http://localhost').searchParams;
    const navId = params.get('nav')?.trim() || '';
    const tab = params.get('tab')?.trim() || '';
    const subgroup = this.settingsSidebarNavEntries.find(
      (entry): entry is SettingsSidebarNavSubgroup =>
        isSettingsSidebarNavSubgroup(entry) && entry.id === sectionId,
    );
    if (!subgroup) {
      return false;
    }
    if (navId) {
      return subgroup.children.some((child) => child.queryParams?.['nav'] === navId);
    }
    if (tab) {
      return subgroup.children.some((child) => child.queryParams?.['tab'] === tab);
    }
    return false;
  }

  private syncSettingsSubgroupsForUrl(url: string): void {
    ...
    if (navId) {
      const match = this.settingsSidebarNavEntries.find(
        (entry) =>
          isSettingsSidebarNavSubgroup(entry) &&
          entry.children.some((child) => child.queryParams?.['nav'] === navId),
      );
      if (match && isSettingsSidebarNavSubgroup(match)) {
        sectionId = match.id;
      }
    } else {
      sectionId = settingsNavSectionForTab(tab);
    }
    if (sectionId) {
      this.settingsNavSubgroupsOpen[sectionId] = true;
    }
  }
  ...
  private syncSidebarNavForUrl(url: string): void {
    const path = (url.split('?')[0] || '').replace(/\/$/, '') || '/';
    const navSection = sidebarSectionFromNavPath(path);
    if (navSection) {
      this.openExclusiveSidebarSection(navSection);
      return;
    }
    ...
    if (onSettings || this.accountJsonEditorOpen) {
      this.openExclusiveSidebarSection('settings');
      this.syncSettingsSubgroupsForUrl(url);
      return;
    }
    ...
    if (this.isFrontDeskSectionUrl(url)) {
      ...
      this.syncFrontDeskSubgroupsForUrl(url);
      return;
    }
    if (this.isBookingsSectionUrl(url)) {
      this.openExclusiveSidebarSection('bookings');
      return;
    }
    if (this.isCashierSectionUrl(url)) {
      this.openExclusiveSidebarSection('cashier');
      return;
    }
    if (this.isCrmSectionUrl(url)) {
      this.openExclusiveSidebarSection('crm');
      return;
    }
    if (this.isNightAuditorSectionUrl(url)) {
      this.openExclusiveSidebarSection('nightAuditor');
      return;
    }
  ...
  private openExclusiveSidebarSection(section: SidebarMainSection): void {
    ...
    for (const key of Object.keys(this.pmsNavOpen) as PmsSidebarSection[]) {
      this.pmsNavOpen[key] = section === key;
    }
    this.persistSidebarSectionOpenState();
  }

  private closeSidebarSection(section: SidebarMainSection): void {
    if (section === 'bookings') {
    ...
    } else if (section in this.pmsNavOpen) {
      this.pmsNavOpen[section as PmsSidebarSection] = false;
    }
    this.persistSidebarSectionOpenState();
  }
  ...
  collapsedFlyoutTitle(section: SidebarMainSection): string {
    switch (section) {
      case 'bookings':
      ...
      case 'cashier':
        return this.ui.sidebarLabel('cashierGroup');
      case 'crm':
        return this.ui.sidebarLabel('crmGroup');
      case 'nightAuditor':
        return this.ui.sidebarLabel('nightAuditorGroup');
      case 'housekeeping':
        return this.ui.sidebarLabel('housekeepingGroup');
      case 'accounts':
        return this.ui.sidebarLabel('accountsGroup');
      case 'settings':
  ...
  private openCollapsedNavFlyout(
    ...
    if (section === 'frontDesk') {
      this.syncFrontDeskSubgroupsForUrl(this.router.url);
    }
  ...
  private isBookingsSectionUrl(url: string): boolean {
    const path = (url.split('?')[0] || '').replace(/\/$/, '') || '/';
    if (sidebarSectionFromNavPath(path) === 'bookings') {
      return true;
    }
    return (
      path === '/rooms' ||
  ...
  private isCashierSectionUrl(url: string): boolean {
    const path = (url.split('?')[0] || '').replace(/\/$/, '') || '/';
    if (sidebarSectionFromNavPath(path) === 'cashier') {
      return true;
    }
    return path === '/cashier/rent-posting' || path.startsWith('/cashier/');
  }

  private isCrmSectionUrl(url: string): boolean {
    const path = (url.split('?')[0] || '').replace(/\/$/, '') || '/';
    if (sidebarSectionFromNavPath(path) === 'crm') {
      return true;
    }
    return path === '/crm/profile-settings' || path.startsWith('/crm/');
  }

  private isNightAuditorSectionUrl(url: string): boolean {
    const path = (url.split('?')[0] || '').replace(/\/$/, '') || '/';
    if (sidebarSectionFromNavPath(path) === 'nightAuditor') {
      return true;
    }
    return path === '/night-auditor/settings' || path.startsWith('/night-auditor/');
  }

  private isHousekeepingSectionUrl(url: string): boolean {
    const path = (url.split('?')[0] || '').replace(/\/$/, '') || '/';
    return sidebarSectionFromNavPath(path) === 'housekeeping';
  }

  private isAccountsSectionUrl(url: string): boolean {
    const path = (url.split('?')[0] || '').replace(/\/$/, '') || '/';
    return sidebarSectionFromNavPath(path) === 'accounts';
  }

  private isFrontDeskKeyMgmtUrl(url: string): boolean {
    const path = (url.split('?')[0] || '').replace(/\/$/, '') || '/';
    return path === '/front-desk/keys' || path === '/front-desk/key-services';
  }

  private syncFrontDeskSubgroupsForUrl(url: string): void {
    if (this.isFrontDeskKeyMgmtUrl(url)) {
      this.frontDeskKeyMgmtOpen = true;
    }
  }

  private isFrontDeskSectionUrl(url: string): boolean {
    const path = (url.split('?')[0] || '').replace(/\/$/, '') || '/';
    if (sidebarSectionFromNavPath(path) === 'frontDesk') {
      return true;
    }
  ...
  private isReportsSectionUrl(url: string): boolean {
    const path = (url.split('?')[0] || '').replace(/\/$/, '') || '/';
    if (sidebarSectionFromNavPath(path) === 'reports') {
      return true;
    }
