...
export class PmsBookingCardComponent {
  ...
  get isArrivingActions(): boolean {
    return this.primaryAction === 'arrivingActions';
  }

  get showArrivingFooter(): boolean {
    return this.isArrivingMenu || this.isArrivingActions;
  }

  get usesActionsMenu(): boolean {
    return this.isStayingMenu || this.isArrivingMenu || this.isArrivingActions || this.isDepartingMenu;
  }
