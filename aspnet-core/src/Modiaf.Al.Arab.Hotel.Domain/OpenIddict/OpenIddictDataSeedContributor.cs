...
namespace Modiaf.Al.Arab.Hotel.OpenIddict;
...
{
    private static readonly string[] AuthorizationOrImplicitGrants =
    [
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("Hotel") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "Hotel", DisplayName = "Hotel API", Resources = { "Hotel" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["Hotel_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["Hotel_App:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["Hotel_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["Hotel_Swagger:RootUrl"]?.TrimEnd('/');
        ...
        List<string>? permissions = null)
    {
        ...
        if (AuthorizationOrImplicitGrants.All(grantTypes.Contains))
        {
