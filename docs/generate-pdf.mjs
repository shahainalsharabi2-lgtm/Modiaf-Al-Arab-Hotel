/**
 * يولّد PDF لدليل أدوات المشروع
 * التشغيل: node docs/generate-pdf.mjs
 */
...
const mdPath = join(__dirname, 'project-tools.md');
const htmlPath = join(__dirname, 'project-tools.html');
const pdfPath = join(__dirname, 'project-tools.pdf');
const pdfPathAr = join(__dirname, 'دليل-أدوات-المشروع.pdf');
...
<head>
  <meta charset="UTF-8"/>
  <title>دليل أدوات Hotel Premio PMS</title>
  <style>
